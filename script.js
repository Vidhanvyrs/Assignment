...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      fetch("https://getform.io/f/bpjmjrqb", {
        method: "POST",
        body: formData,
        headers: {
...
const contentArray = [
  {
    imagePath: "Assets/images/young-cheerful-people-having-fun-together.jpg",
  ...
  {
    imagePath:
      "Assets/images/student-sharing-her-knowledge-with-her-colleagues.jpg",
    title: "Genderless Kei - Japan's Hot",
    description:
      "Set to launch on the manufacturer's new A330neo aircraft in 2017, it's offering lots of",
  },
